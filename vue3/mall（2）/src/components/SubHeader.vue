    ...
    <div style="height: 50px ">
        ...
        :class="{'active': state.headerScroll}">
            <div class="item item_logo">
                <img src="https://iconfont.alicdn.com/p/illus/preview_image/B4bRC8pGF0SE/b70fc572-5880-4ca2-af5e-7ebaab441a6f.png" alt="">
            </div>
            <div class="item item_main">
                <van-icon class="search" size=".4rem" name="search" />
                <router-link class="search-title" to="/category">
                    输入你想搜索的商品
                </router-link>
